...
use windows_sys::Win32::Foundation::{
    ...
    OLE_E_ADVISENOTSUPPORTED, OLE_E_WRONGCOMPOBJ, POINT, POINTL, RPC_E_CHANGED_MODE, S_FALSE,
    S_OK,
};
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self.0 {
            RPC_E_CHANGED_MODE => write!(
                f,
                "OleInitialize failed: `RPC_E_CHANGED_MODE`. Make sure other crates are not \
                 using multithreaded COM library on the same thread or disable drag-and-drop \
